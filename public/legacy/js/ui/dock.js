...
var DOCK_GROUPS = ['trading', 'review', 'intel', 'expand'];

// ── ENABLED DOCK IDS (modules with page view wired) ──────────
// Add ids here as each module gets its dedicated page view
var DOCK_ENABLED = ['autotrade', 'manual-trade', 'dsl', 'ares', 'postmortem', 'pnllab', 'aria', 'nova', 'adaptive', 'flow', 'mtf', 'teacher', 'sigreg', 'activity', 'aub'];

// ── RENDER ─────────────────────────────────────────────────────
function initZeusDock() {
  ...
  dock.addEventListener('click', function(e) {
    ...
    if (typeof openPageView === 'function') {
      openPageView(dockId);
    }
  });
}
