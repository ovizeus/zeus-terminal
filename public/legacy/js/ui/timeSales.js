/* ───────────────────────────────────────────────────────────────
   Zeus Terminal — Time & Sales Tape (timeSales.js)
   v1.0.0 | 2026-03-27

   Read-only display of RAW_FLOW.buf (aggTrade stream).
   Does NOT create new WebSocket connections.
   Does NOT modify any existing state or module.
   ─────────────────────────────────────────────────────────────── */
(function () {
  'use strict';

  if (window.__ZEUS_TS__) return;
  window.__ZEUS_TS__ = true;
  ...
  window.toggleTimeSales = _toggle;
  ...
  window.toggleTimeSales = function () {
    _origToggle();
