...
if (typeof window !== 'undefined') window.TEACHER = _initTeacherState();
...
// [P2] Node.js compatibility — export constants for server use
if (typeof module !== 'undefined' && module.exports) {
  module.exports = { TEACHER_IND_DEFAULTS, TEACHER_FEES, TEACHER_TRADE_DEFAULTS, TEACHER_TIMEFRAMES };
}
