...
mockDb.exec(`
    ...
    CREATE TABLE at_closed (seq INTEGER PRIMARY KEY, data TEXT, status TEXT, user_id INTEGER, exchange TEXT DEFAULT 'bybit', created_at TEXT DEFAULT (datetime('now')), updated_at TEXT DEFAULT (datetime('now')));
