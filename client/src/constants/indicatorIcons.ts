...
export const IND_ICONS: Record<string, string> = {
  ...
  phoebe: g(dot(8, 8, 1.3) + p('M10.3 6a3 3 0 010 4') + p('M5.7 6a3 3 0 000 4') + p('M12.3 4.3a5.2 5.2 0 010 7.4') + p('M3.7 4.3a5.2 5.2 0 000 7.4')), // resonance — radiating concentric arcs
