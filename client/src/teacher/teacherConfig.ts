// Zeus — teacher/teacherConfig.ts
// Ported 1:1 from public/js/teacher/teacherConfig.js (Phase 7C)
...
// ══════════════════════════════════════════════════════════════════
export const TEACHER_FEES = Object.freeze({
...
// INDICATOR DEFAULTS
// ══════════════════════════════════════════════════════════════════
export const TEACHER_IND_DEFAULTS = Object.freeze({
  rsiPeriod: 14,
  adxPeriod: 14,
  macdFast: 12,
  macdSlow: 26,
...
// REPLAY DEFAULTS
// ══════════════════════════════════════════════════════════════════
export const TEACHER_REPLAY_DEFAULTS = Object.freeze({
...
// ══════════════════════════════════════════════════════════════════
export const TEACHER_TRADE_DEFAULTS = Object.freeze({
...
// ══════════════════════════════════════════════════════════════════
export const TEACHER_TAGS = Object.freeze({
  entryReasons: [
...
// TIMEFRAME CONFIGS
// ══════════════════════════════════════════════════════════════════
export const TEACHER_TIMEFRAMES: any = Object.freeze({
...
// ══════════════════════════════════════════════════════════════════
export const TEACHER_STORAGE_KEYS: any = Object.freeze({
...
// ══════════════════════════════════════════════════════════════════
export function _initTeacherState(): any {
  return {
    // ── status ──
...
;(function _teacherConfigIIFE() {
  if (typeof window !== 'undefined') w.TEACHER = _initTeacherState()
})()

// Reset to clean state (for new session)
export function teacherResetState(): void {
  if (typeof window !== 'undefined') w.TEACHER = _initTeacherState()
}

// Attach to window for cross-file access
;(function _teacherConfigGlobals() {
  if (typeof window !== 'undefined') {
    w.TEACHER_FEES = TEACHER_FEES
    w.TEACHER_IND_DEFAULTS = TEACHER_IND_DEFAULTS
    w.TEACHER_REPLAY_DEFAULTS = TEACHER_REPLAY_DEFAULTS
    w.TEACHER_TRADE_DEFAULTS = TEACHER_TRADE_DEFAULTS
    w.TEACHER_TAGS = TEACHER_TAGS
    w.TEACHER_TIMEFRAMES = TEACHER_TIMEFRAMES
    w.TEACHER_STORAGE_KEYS = TEACHER_STORAGE_KEYS
    w._initTeacherState = _initTeacherState
    w.teacherResetState = teacherResetState
  }
})()
