  ...
  return (
    <ModalOverlay id="mcloud" visible={visible} onClose={onClose}>
      ...
      <div style={{ padding: '14px 16px' }}>
        {/* Privacy box — 1:1 from index.html lines 2978-2985 */}
        <div style={{
        ...
        {/* Danger zone — FIX 16: Master Reset */}
        <div style={{ marginTop: 16, paddingTop: 12, borderTop: '1px solid #ff335522' }}>
          ...
          <button style={{
            ...
            <svg className="z-i" viewBox="0 0 16 16" style={{ color: '#ff4466' }}>
              <path d="M5 6h.01M11 6h.01M4 3a5 5 0 018 0c1 2 1 4-1 6H5c-2-2-2-4-1-6M6 12v2m4-2v2" />
            </svg> MASTER RESET — ȘTERGE TOT
          </button>
