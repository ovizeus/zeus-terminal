    ...
    <ModalOverlay id="malerts" visible={visible} onClose={onClose}>
      ...
      <div style={{ padding: '12px 16px', overflowY: 'auto', maxHeight: '75vh' }}>
        ...
        <div style={{
          ...
          <button className="sndbtn" id="snd" style={{ fontSize: 14, padding: '4px 10px', borderRadius: 6 }}>&#128277;</button>
        </div>
        ...
        <div style={{ background: '#0d1018', border: '1px solid #333', borderRadius: 6, padding: 10, marginBottom: 8 }}>
          ...
          <label className="mchk"><input type="checkbox" id="aVolSpike" defaultChecked /> Enable Volume Spike Alerts</label>
        ...
        <div style={{ background: '#0d1018', border: '1px solid #333', borderRadius: 6, padding: 10, marginBottom: 8 }}>
          ...
          <label className="mchk"><input type="checkbox" id="aWhaleOrders" defaultChecked /> Enable Whale Order Alerts</label>
          ...
          <div style={{ marginTop: 6, fontSize: 8, color: 'var(--dim)' }}>
            Alert When:<br />
            <label className="mchk" style={{ margin: '3px 0' }}><input type="checkbox" id="aWhaleBid" defaultChecked /> <span className="z-dot z-dot--grn"></span> Large BIDs Added (Bullish)</label>
            <label className="mchk" style={{ margin: '3px 0' }}><input type="checkbox" id="aWhaleAsk" defaultChecked /> <span className="z-dot z-dot--red"></span> Large ASKs Added (Bearish)</label>
        ...
        <div style={{ background: '#0d1018', border: '1px solid #333', borderRadius: 6, padding: 10, marginBottom: 8 }}>
          ...
          <label className="mchk"><input type="checkbox" id="aLiqEn" defaultChecked /> Enable Liquidation Alerts</label>
        ...
        <div style={{ background: '#0d1018', border: '1px solid #333', borderRadius: 6, padding: 10, marginBottom: 8 }}>
          ...
          <label className="mchk"><input type="checkbox" id="aDivEn" defaultChecked /> Enable Divergence Alerts</label>
          <div style={{ fontSize: 8, color: 'var(--dim)', margin: '4px 0' }}>Indicators:</div>
          <label className="mchk"><input type="checkbox" id="aDivRSI" defaultChecked /> RSI Divergences</label>
          <label className="mchk"><input type="checkbox" id="aDivMACD" defaultChecked /> MACD Divergences</label>
          <div style={{ fontSize: 8, color: 'var(--dim)', margin: '4px 0' }}>Types:</div>
          <label className="mchk"><input type="checkbox" id="aDivBull" defaultChecked /> Bullish (price LL + indicator HL)</label>
          <label className="mchk"><input type="checkbox" id="aDivBear" defaultChecked /> Bearish (price HH + indicator LH)</label>
          <label className="mchk"><input type="checkbox" id="aDivHid" /> Hidden Divergences</label>
        </div>

        {/* Pivot Level Alerts */}
        <div style={{ background: '#0d1018', border: '1px solid #333', borderRadius: 6, padding: 10, marginBottom: 8 }}>
          <div style={{ color: 'var(--gold)', fontSize: 10, fontWeight: 700, marginBottom: 8 }}>Pivot Level Alerts</div>
          <label className="mchk"><input type="checkbox" id="aPivotEn" /> Enable Pivot Level Crossing Alerts</label>
        ...
        <div style={{ background: '#0d1018', border: '1px solid #333', borderRadius: 6, padding: 10, marginBottom: 8 }}>
          ...
          <label className="mchk"><input type="checkbox" id="aRSIEn" defaultChecked /> Enable RSI Alerts</label>
          <label className="mchk"><input type="checkbox" id="aRSIOB" defaultChecked /> Alert when RSI &gt; 70 (Overbought)</label>
          <label className="mchk"><input type="checkbox" id="aRSIOS" defaultChecked /> Alert when RSI &lt; 30 (Oversold)</label>
        </div>
