...
const IND_LIST: IndMeta[] = [
  ...
  { id: 'iris',     ico: '🌈', name: 'IRIS',             desc: 'Rainbow EMA ribbon — trend strength (Zeus original)', hasGenericSettings: true },
  { id: 'pythia',   ico: '🔮', name: 'PYTHIA',           desc: 'Entry oracle + targets, brain-backed (Zeus original)', hasGenericSettings: true },
  ...
  { id: 'anemoi',   ico: '🌬️', name: 'ANEMOI',            desc: 'Volume anomaly — surge & dead-air detector (Zeus original)', hasGenericSettings: true },
  ...
  { id: 'ouranos',  ico: '🌌', name: 'OURANOS',           desc: 'Auto regression channel — trend rails (Zeus original)', hasGenericSettings: true },
  ...
  { id: 'harmonia', ico: '🌈', name: 'HARMONIA',          desc: 'Rainbow spectrum candle painter + dual-degree swing arrows (Zeus original)', hasGenericSettings: true },
