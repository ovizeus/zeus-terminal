...
export const INDICATORS: any[] = [
  ...
  { id: 'mentor', ico: _ZI.tup, name: 'MENTOR', desc: 'FX Market Code — 50MA trend + 4-state candle recolour + OsMA momentum pane 🧭', cat: 'trend', def: false },
  ...
  // [2026-06-16] AETHER — Zeus original volatility squeeze / breakout field
  ...
  { id: 'phoebe', ico: _ZI.wave, name: 'PHOEBE', desc: 'Quantum Resonance Engine — lower heatmap oscillator (resonance −100..100) + on-chart order blocks, support/resistance, Buy/Sell signals & Entry/TP/SL, plus a multi-timeframe matrix panel. Full SMC suite (Zeus original)', cat: 'momentum', def: false },
  ...
  { id: 'harmonia', ico: _ZI.wave, name: 'HARMONIA', desc: 'Rainbow spectrum candle painter + dual-degree swing arrows 🌈', cat: 'trend', def: false },
  { id: 'daimon', ico: _ZI.scope, name: 'DAIMON', desc: 'A chart wizard that walks, reads the market & calls trades 🧙', cat: 'trend', def: false },
]
