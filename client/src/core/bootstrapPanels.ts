...
const _CMD_ACTIONS: any[] = [
  { cat: 'symbol', label: 'BTC \u2014 Bitcoin', icon: '\u20BF', action: function () { (w.setSymbol || setSymbol)('BTCUSDT') }, keys: 'btc bitcoin' },
  { cat: 'symbol', label: 'ETH \u2014 Ethereum', icon: '\u039E', action: function () { (w.setSymbol || setSymbol)('ETHUSDT') }, keys: 'eth ethereum' },
  { cat: 'symbol', label: 'SOL \u2014 Solana', icon: '\u25CE', action: function () { (w.setSymbol || setSymbol)('SOLUSDT') }, keys: 'sol solana' },
