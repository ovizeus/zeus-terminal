...
export var DOCK_ITEMS: any[] = [
  ...
  // S/R Levels). MIRROR entry also added in ZeusDock.tsx DOCK_ITEMS — both lists
  // must stay in sync (documented 2026-05-21 gotcha).
  { id: 'market-metrics', label: 'Metrics', group: 'intel',
    svg: '<path d="M3 21h18" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/><rect x="4" y="14" width="4" height="7" rx="1" fill="currentColor" opacity=".25"/><rect x="4" y="14" width="4" height="7" rx="1" fill="none" stroke="currentColor" stroke-width="1.3"/><rect x="10" y="9" width="4" height="12" rx="1" fill="currentColor" opacity=".25"/><rect x="10" y="9" width="4" height="12" rx="1" fill="none" stroke="currentColor" stroke-width="1.3"/><rect x="16" y="5" width="4" height="16" rx="1" fill="currentColor" opacity=".25"/><rect x="16" y="5" width="4" height="16" rx="1" fill="none" stroke="currentColor" stroke-width="1.3"/>' },
